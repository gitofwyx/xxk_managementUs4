...
public class BaseController {
	...
	protected ImageInfo uploadImage(MultipartFile file, String realPath) {
		return uploadImage(file, SCALE, QUALITY, realPath);
	}
	/**
	 ...
	 * @return
	 */
	protected ImageInfo uploadImage(MultipartFile file, double scale, double quality, String realPath) {
	 ...
	 * @return
	 */
	protected Map<String, Object> uploadFile() {
		return uploadFile();
	}
