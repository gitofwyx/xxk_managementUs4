...
public interface DevicesDao {
    ...
    public int updateDevicesStatus(String devicesId,String location_office_id,String present_stock_id,String in_storage_id,String delivery_id,String status,String userId,String Date,String cond);
